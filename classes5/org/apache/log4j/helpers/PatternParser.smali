...
.method protected extractPrecisionOption()I
    ...
    const-string v0, "Precision option ("
    ...
    move-result v3
    :try_end_d
    .catch Ljava/lang/NumberFormatException; {:try_start_9 .. :try_end_d} :catch_2b
    ...
    :try_end_25
    .catch Ljava/lang/NumberFormatException; {:try_start_f .. :try_end_25} :catch_26
...
.method protected finalizeConverter(C)V
    ...
    const-string v0, " in conversion patterrn."
    ...
    :try_end_c2
    .catch Ljava/lang/IllegalArgumentException; {:try_start_bd .. :try_end_c2} :catch_c4
