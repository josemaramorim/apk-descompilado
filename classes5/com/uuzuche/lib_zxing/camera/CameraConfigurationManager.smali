...
.method private static findBestMotZoomValue(Ljava/lang/CharSequence;I)I
    ...
    .line 179
    sget-object v0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->COMMA_PATTERN:Ljava/util/regex/Pattern;
...
.method private static findBestPreviewSizeValue(Ljava/lang/CharSequence;Landroid/graphics/Point;)Landroid/graphics/Point;
    ...
    .line 144
    sget-object v7, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->TAG:Ljava/lang/String;
    ...
    move-result v6
    :try_end_44
    .catch Ljava/lang/NumberFormatException; {:try_start_32 .. :try_end_44} :catch_60
...
.method private static getCameraResolution(Landroid/hardware/Camera$Parameters;Landroid/graphics/Point;)Landroid/graphics/Point;
    ...
    .line 121
    sget-object p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->TAG:Ljava/lang/String;
    ...
    .line 122
    invoke-static {v0, p1}, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->findBestPreviewSizeValue(Ljava/lang/CharSequence;Landroid/graphics/Point;)Landroid/graphics/Point;
...
.method private setZoom(Landroid/hardware/Camera$Parameters;)V
    ...
    .line 239
    :catch_49
    sget-object v5, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->TAG:Ljava/lang/String;
    ...
    .line 245
    invoke-static {v5, v3}, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->findBestMotZoomValue(Ljava/lang/CharSequence;I)I
    ...
    rem-int v6, v3, v6
    :try_end_80
    .catch Ljava/lang/NumberFormatException; {:try_start_70 .. :try_end_80} :catch_82
...
.method initFromCameraParameters(Landroid/hardware/Camera;)V
    ...
    iput v0, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->previewFormat:I
    ...
    iput-object v0, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->previewFormatString:Ljava/lang/String;

    .line 55
    sget-object v0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->TAG:Ljava/lang/String;
    ...
    iget v2, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->previewFormat:I
    ...
    iget-object v2, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->previewFormatString:Ljava/lang/String;
    ...
    .line 56
    iget-object v1, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->context:Landroid/content/Context;
    ...
    iput-object v2, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->screenResolution:Landroid/graphics/Point;
    ...
    iget-object v2, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->screenResolution:Landroid/graphics/Point;
    ...
    iget-object v3, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->screenResolution:Landroid/graphics/Point;
    ...
    .line 70
    invoke-static {p1, v1}, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->getCameraResolution(Landroid/hardware/Camera$Parameters;Landroid/graphics/Point;)Landroid/graphics/Point;

    move-result-object p1

    iput-object p1, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->cameraResolution:Landroid/graphics/Point;
    ...
    iget-object v1, p0, Lcom/uuzuche/lib_zxing/camera/CameraConfigurationManager;->screenResolution:Landroid/graphics/Point;
