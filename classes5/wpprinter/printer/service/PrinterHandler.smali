...
.method private handleAutoStatusBack([BI)Z
    ...
    if-ne p2, v0, :cond_1f1

    and-int/lit8 p2, p1, 0xc

    if-ne p2, v2, :cond_1ca
...
.method public dispatchMessage([B)V
    ...
    :try_end_b
    .catch Ljava/nio/BufferOverflowException; {:try_start_6 .. :try_end_b} :catch_c
    ...
    if-eq v5, v7, :cond_60b

    const/16 v7, 0x9

    if-eq v5, v7, :cond_5e5

    const/16 v7, 0x5a

    const/16 v11, 0x16

    if-eq v5, v11, :cond_545

    if-eq v5, v7, :cond_3f7

    const/16 v3, 0x1a

    const/16 v7, 0xa

    if-eq v5, v3, :cond_3a2

    const/16 v3, 0x1b

    if-eq v5, v3, :cond_36a

    const/16 v3, 0x12

    const/16 v11, 0x60

    packed-switch v5, :pswitch_data_81c
    ...
    if-ne v0, v15, :cond_81a

    aget-byte v0, v2, v4

    and-int/lit8 v5, v0, 0x12

    if-ne v5, v3, :cond_81a

    and-int/2addr v0, v9

    if-ne v0, v9, :cond_1b9
    ...
    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;
    :try_end_53d
    .catch Ljava/lang/RuntimeException; {:try_start_4bc .. :try_end_53d} :catch_53f
    ...
    if-ne v2, v3, :cond_813

    and-int/lit8 v2, v0, 0x4

    if-ne v2, v14, :cond_6d3
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :try_end_13d
    .catch Ljava/lang/InterruptedException; {:try_start_13a .. :try_end_13d} :catch_13e
